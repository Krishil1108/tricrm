...
const YearlyDistributionTable = ({ 
  ...
  // If snapshot exists but ALL 6 default fields are explicitly false, it means the snapshot
  // was stored with a bad/empty configuration — fall back to showing everything.
  const _snapshotAllHidden = hasSnapshot &&
    _snapshotFV.profitMargin === false &&
    _snapshotFV.drawing === false &&
    _snapshotFV.documents === false &&
    _snapshotFV.siteVisit === false &&
    _snapshotFV.marketingAndMisc === false &&
    _snapshotFV.officeManagement === false;
  const effectiveFieldVisibility = (hasSnapshot && !_snapshotAllHidden) ? {
