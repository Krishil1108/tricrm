      ...
      <div className="modern-page-header">
        <div className="header-content-enhanced">
          ...
          <div className="header-actions-enhanced">
            ...
            {/* Financial Overview shortcut */}
            <button
              className="btn-primary-modern"
              onClick={() => navigate('/finance')}
              style={{ background: 'linear-gradient(135deg, #1d4ed8, #7c3aed)', gap: '6px' }}
              title="Open Financial Overview Dashboard"
            >
              <div className="btn-icon-wrapper">
                <svg width="16" height="16" viewBox="0 0 24 24" fill="currentColor">
              ...
              <span className="btn-text">Financial Overview</span>
            </button>
          </div>
        </div>
      </div>
        ...
        <div className="payments-section">
          {formData.payments.map((payment, index) => (
            <div key={payment.id} className="payment-row">
              ...
              {/* All 4 payment fields in one row */}
