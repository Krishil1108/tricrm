        ...
        <div className="form-row">
          <div className="form-group">
            ...
            <div className="logo-upload">
              <div className="logo-preview" onClick={() => document.getElementById('logo-input').click()} style={{ cursor: 'pointer' }}>
              ...
              />
              <span className="upload-text" onClick={() => document.getElementById('logo-input').click()}>
                Click to upload logo (recommended: 200x200px)
              </span>
            </div>
          </div>
        </div>
